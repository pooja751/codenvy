...
public class InviteServicePermissionsFilterTest {
  ...
  @Mock private InviteService service;

  @InjectMocks private InviteServicePermissionsFilter permissionsFilter;
  ...
  @Test
  public void shouldRespond403WhenUserDoesNotHaveCorrespondingPermissionOnInvitesGetting()
      throws Exception {
    when(subject.hasPermission(anyString(), anyString(), anyString())).thenReturn(false);
  ...
  @Test
  public void shouldRespond403WhenUserDoesNotHaveCorrespondingPermissionOnInvitesRemoving()
      throws Exception {
    when(subject.hasPermission(anyString(), anyString(), anyString())).thenReturn(false);
