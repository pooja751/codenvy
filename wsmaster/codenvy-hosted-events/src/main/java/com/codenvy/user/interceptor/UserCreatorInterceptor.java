 ...
 *
 * <p>The purpose of the interceptor is to send "welcome to codenvy" email to user after its
 * creation.
 *
...
public class UserCreatorInterceptor implements MethodInterceptor {
  ...
  public Object invoke(MethodInvocation invocation) throws Throwable, ApiException {
    ...
    try {
      ...
      notificationSender.sendNotification(createdUser.getName(), createdUser.getEmail(), false);
    } catch (Exception e) {
