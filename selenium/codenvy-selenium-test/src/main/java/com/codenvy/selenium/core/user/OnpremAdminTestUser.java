...
public class OnpremAdminTestUser implements AdminTestUser {
  private static final String CODENVY_ADMIN_NAME_PROPERTY = "codenvy.admin.name";
  private static final String CODENVY_ADMIN_PASSWORD_PROPERTY = "codenvy.admin.password";
  private static final String CODENVY_ADMIN_INITIAL_PASSWORD_PROPERTY =
      "codenvy.admin.initial_password";
